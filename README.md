...
Pol si dal desno tam edge cuts in narisal pravokotnik 40x40 z r = 2 mm zaokroženimi robovi in premaknil usb port pa mikrokrilnik na prava mesta. da se ti lepo poravna se mal igraš z scale gor da bo snap grid. ko maš narisano daš na desnem meniju najprej draw filled zones in označiš Fcu in BCu pa daš ground in narišeš pravokotnik iz notranjih robov zaokrožitev, se pravi spodaj zgoraj ne levo desno (upam da razumeš). Pol daš pa še draw rule areas, obkljukaš F.CU in B.Cu in narišeš pravokotnik po čisto zunanjih gabaritih. pol pa klikneš B in ti neki pobarva. to je mislim da kaj more bit z bakrom zalito.

## 4. vaja
Dans je kao samostojni del --> zaključit shemo pa pcb drawing. Baje mormo zdej sami pogruntat kaj še mormo naredit pa nardit.
Glede na shemo narediš postavitev (po logiki čim bližji). 
<br>Zdej nam je pokazu še kar je prejšn tedn pozabu. Najprej pozicioniranje elementov (nadrkan je na simetrijo pa konsistentne odmike). Po USB-C pa mikrokrmilniku damo gor velike komponente (gumb na levi strani od krmilnika, ...). Pri tem gledaš, da je orientacija pravilna, vodijo te pa modre črtice (ki ti povejo kaj je s čim povezan). Glih zarad tega smo bli tk kao pozorni pri shemi da smo naredl postavitev čim bolj logično. Pozicioniru je zdej gumba na levo pa desno, J1-4 je dau na strani, senzor pa lučko tk kinda na sredino.
Določene stvari lah damo na zadnjo stran (niso pomembne jih ne rabiš videt). Mextem ko jo premikaš (M) klikneš F (Flip). To gre potem na BCL (Back copper layer). Na zadnji del damo bejsikli vse kar je ostal. Zdej je končn začeu razlagat kak se povežejo stvari (najprej je šou v tk levo gor pod board settijngs ko piše 'track use netclass with pa čist ta spodno stvar klikneš (custom) pa daš notr svoje velikosti (od 0,25 mm do 1mm)) Kr je naša ploščica dost simpl ni treba merkat da so vse povezave enako dolge pa pravilno široke (pa d ani ccross tokov pa vsega tega). Pol tm pod dropdown meniju izbrerš željeno širino pa začneš risat povezave. Dokaj hitr prideš do problema da se bi ti mogle povezave križat. Takrat nardiš trough via (skoznjo pot al neki fuck do i care). Medtem ko rišeš daš desni klik --> place trough via pa pol rišeš na backsidu --> še enkrat isto pa si naredu mostiček. Pri risanju povezav probi met vedno kote 45° in ne 90°.
To sranje je mal krneki, uzel bi ful cajta --> bomo kr prekopiral iz gita.